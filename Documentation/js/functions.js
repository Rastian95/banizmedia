...
(function($){
	...
	SEMICOLON.initialize = {
		...
		init: function(){
			...
			SEMICOLON.initialize.imagePreload( '.portfolio-item:not(:has(.fslider)) images' );
	...
	SEMICOLON.widget = {
					...
					if( dribbbleType == 'follows' ) {
						$.jribbble.getShotsThatPlayerFollows( dribbbleUsername , function (followedShots) {
							...
							$.each(followedShots.shots, function (i, shot) {
								...
								html.push('<images src="' + shot.image_teaser_url + '" ');
		...
		extras: function(){
			...
			// var el = {
			//     darkLogo : $("<images>", {src: defaultDarkLogo}),
			//     darkRetinaLogo : $("<images>", {src: retinaDarkLogo})
			// };
